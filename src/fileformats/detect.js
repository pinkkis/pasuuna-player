...
class FileType {
	...
	static get mod_ProTracker() { return { name: 'PROTRACKER', isMod: true, loader: () => new ProTracker() }; }
	static get mod_SoundTracker() { return { name: 'SOUNDTRACKER', isMod: true, loader: () => new SoundTracker() }; }
	static get mod_FastTracker() { return { name: 'FASTTRACKER', isMod: true, loader: () => new FastTracker() }; }
